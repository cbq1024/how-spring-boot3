package com.mcddhub.integration.e2e;

import com.mcddhub.repository.UserRepository;
import com.mcddhub.repository.UserRoleMapRepository;
...
@TestPropertySource(
    properties = {
        "spring.datasource.url=jdbc:tc:postgresql:15.4-alpine:///postgres?TC_INITSCRIPT=file:db.d/init/V01__init.sql",
