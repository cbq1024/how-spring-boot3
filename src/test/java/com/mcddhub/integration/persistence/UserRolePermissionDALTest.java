package com.mcddhub.integration.persistence;
...
import com.mcddhub.dto.urp.RoleQueryDto;
import com.mcddhub.dto.urp.UserQueryDto;
import com.mcddhub.repository.*;
...
public class UserRolePermissionDALTest extends AbstractDataAccessLayerTest {
  ...
  @Test
  @Sql(statements = "INSERT INTO db.user_role_map (id, user_id, role_id) VALUES (1, 1, 1)")
  ...
  @Sql(
      statements =
          "INSERT INTO db.role_permission_map (id, role_id, permission_id) VALUES (1, 1, 1)")
  ...
  @Sql(
      statements = {
        "INSERT INTO db.user (id, username, password) VALUES (1, 'testUserA','5EUX1AIlV09n2o')",
        "INSERT INTO db.role (id, code, name) VALUES (1, 'testRoleA', 'testRoleA')",
        "INSERT INTO db.user_role_map (id, user_id, role_id) VALUES (1, 1, 1)",
        "INSERT INTO db.role_permission_map (id, role_id, permission_id) VALUES (1, 1, 1)",
        "INSERT INTO db.role_permission_map (id, role_id, permission_id) VALUES (2, 1, 2)",
        "INSERT INTO db.permission (id, code, name) VALUES (1, 'testPermissionA',"
            + " 'testPermissionA')",
        "INSERT INTO db.user (id, username,password) VALUES (2, 'testUserB','NTjRCeUq2EqCy')",
        "INSERT INTO db.user_role_map (id, user_id, role_id) VALUES (2, 2, 2)",
        "INSERT INTO db.role (id, code, name) VALUES (2, 'testRoleB', 'testRoleB')",
        "INSERT INTO db.role_permission_map (id, role_id, permission_id) VALUES (3, 2, 2)",
        "INSERT INTO db.permission (id, code, name) VALUES (2, 'testPermissionB',"
            + " 'testPermissionB')",
      })
  ...
  @Sql(
      statements = {
        "INSERT INTO db.user (id, username, password) VALUES (1, 'testA','5EUX1AIlV09n2o')",
        "INSERT INTO db.user (id, username,password) VALUES (2, 'testB','NTjRCeUq2EqCy')",
      })
